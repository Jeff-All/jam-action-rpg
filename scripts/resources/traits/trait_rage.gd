...
func _on_character_cur_resource_change(resource: CharacterCampaign.Resources, _cur: int, change: float):
	if resource == CharacterCampaign.Resources.HEALTH && change < 0:
